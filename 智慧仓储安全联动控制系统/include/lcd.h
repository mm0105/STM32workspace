 ...
 * 返 回 值: 无
 ***************************************************************/
void lcd_show_chinese(uint16_t x, uint16_t y, const char *s, uint16_t fc, uint16_t bc, uint8_t sizey, uint8_t mode);
...
/***************************************************************
* 函数名称: lcd_show_text
* 说    明: 中英文混合显示(简化版 - 包含中英文解析,font_size 可选 12/16/24/32)
* 参    数:
*       @x/y: 起始坐标
*       @str: 字符串(UTF-8, 中文按 3 字节处理)
*       @fc/@bc: 前景/背景色
*       @font_size: 字号
*       @mode: 0=非叠加, 1=叠加
* 返 回 值: 无
